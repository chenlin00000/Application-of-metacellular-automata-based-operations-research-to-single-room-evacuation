...
Barrier = list()
# Barrier.append(Init_Barrier(A=(35, 20), B=(65, 40)))
Barrier.append(Init_Barrier(A=(20, 0), B=(30, 40)))
Barrier.append(Init_Barrier(A=(50, 30), B=(60, 60)))
Barrier.append(Init_Barrier(A=(70, 0), B=(80, 40)))

Exit = Init_Exit(P1=(100, 25), P2=(100, 35))
# Exit = Init_Exit(P1=(100, 15), P2=(100, 20))
# Exit.extend(Init_Exit(P1=(100, 30), P2=(100, 35)))
